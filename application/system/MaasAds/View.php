...
class View
{
     ...
     */
    public function render($filename, $locals = array(), $layout = 'default', $render_without_header_and_footer = false)
    {
       $layout = LAYOUTS_PATH . $layout . '.php';
       
       if(!file_exists($layout)) {
          trigger_error('Layout '.$layout.' is not available. Using default.', E_USER_NOTICE);
          $layout = LAYOUTS_PATH . 'default.php';
       }
      
       // parse locals into scope and apply to template
       ob_start();
